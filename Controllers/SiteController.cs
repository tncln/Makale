...
using MYMAKALE.UTILITIES.StringOperations;
using System;
...
namespace MYMAKALE.WEB.Controllers
{
    public class SiteController : PublicController
    {
        ...
        public SiteController(IUnitofWork uow, IPostService postService, ICategoryService categoryService, IUserService userService)
            : base(uow)
        {
            _uow = uow;
